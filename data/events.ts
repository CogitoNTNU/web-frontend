...
// Corrupted image files - using placeholder
...
const ProjectPresentations_V25 = Presentation; // Placeholder
const Fest = CogitoNight; // Placeholder
const ProsjektlederOppstart = Presentation; // Placeholder
