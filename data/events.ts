...
export const hardcodedEvents: Array<EventType> = [
  {
    ...
    timeString: "Tirsdager fom. 09.09",
  ...
  },
  {
    ...
    timeString: "05.08",
    location: "TBA",
    description: "Velkommen til Cogitos årlige generalforsamling! Her presenteres årsrapporter, valg av nytt styre, og viktige vedtak for fremtiden. Din stemme teller!",
    image: CogitoNight,
  },
  {
    ...
    location: "TBA",
    description: "Bli med på planleggingen av spennende nye prosjekter for semesteret! Vi diskuterer ideer, teknologier og setter opp team for å skape noe fantastisk sammen.",
    image: CogitoNight,
  },
  {
    ...
    location: "TBA",
    description: "Møte for prosjektledere! Vi deler erfaringer, diskuterer lederskap og klargjør forventninger for semesteret. Gode råd inkludert!",
  ...
  },
  {
    ...
    location: "Gruva, Oppredning/gruvedrift, Gløshaugen",
    description: "Første Cogito-kveld for det nye semesteret! En fantastisk mulighet til å bli kjent med andre medlemmer, nyte deilig pizza, og finne din prosjektgruppe. Kom og opplev det gode fellesskapet i Cogito!",
    image: Welcome,
  },
  {
    ...
    description: "Lær essensielle utviklingsverktøy som Git, pre-commit hooks, GitHub Actions og Docker. Etter workshopen tar vi en velfortjent bowlingrunde for å feire at alle har fått sine første commits!",
    image: Bowling,
  },
  {
    name: "Kurs - Datasyn",
  ...
  },
  {
    ...
    location: "TBA",
    description: "Time to party! 🎉 Bli med på vors og fest hvor vi feirer et flott semester så langt. God mat, drikke og enda bedre selskap!",
    image: Fest,
  },
  {
    ...
    subTimeString: "lørdag",
    location: "TBA",
    description: "En hel dag med koding, kreativitet og kaffe! Vårt interne hackathon hvor Cogito-medlemmer konkurrerer i lag for å skape innovative løsninger. Premier, pizza og mye moro!",
  ...
  },
  {
    ...
    subTimeString: "lørdag",
    location: "TBA",
    description: "Slapp av med en koselig brettspillkveld! Bli med på Secret Hitler, poker og mange andre spill. Snacks og drikke serveres!",
    image: BoardGames,
  },
  {
    ...
    location: "TBA",
    description: "Semesterets høydepunkt! Se alle de fantastiske prosjektene våre medlemmer har jobbet med. Presentasjoner og morsomme nominasjoner!",
