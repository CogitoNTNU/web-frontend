...
const Form = ({ isModalOpen, selectedProject, setIsModalOpen, handleProjectInfoClick }: FormProps) => {
  ...
  return (<>
    {!sent ? (<div className="bg-gray-lighter rounded-lg">
      ...
      <div className="tablet:h-[400px] h-[500px] w-full flex justify-center text-center items-center px-2">
        <div>
          ...
          <p className="tablet:text-[16px] text-[14px]">
            Oppmøte og datoer vil bli sendt til deg på epost/telefon
            snarest mulig. Vi gleder oss til å møte deg!
          </p>
        </div>
      </div>)}
  </>)
      ...
      <div className="h-80 flex gap-8 items-center justify-center w-full">
        ...
        <div className="w-[500px] tracking-wide">
          <p className=" font-bold text-blue-darker leading-[30px]">
             <span className="text-[16px] font-normal text-blue-darkest">Søknadsperioden for å bli med som prosjektmedlem i Cogito <span className="text-pink-default font-semibold">er nå avsluttet</span>. Men fortvil ikke! Vi vil søke etter nye prosjektmedlemmer neste semester og vær på utkikk etter verv i nær framtid.
            </span>
          </p>
        </div>
      </div>
            ...
            <div className="w-full h-fit flex justify-center">
              <div className="w-[95%] h-fit rounded-3xl">
                {isDueDate(dueDate) ?
                  <Due/>
                  :
                  <Form handleProjectInfoClick={handleProjectInfoClick} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} selectedProject={selectedProject} />
                }
              </div>
            </div>
          </div >
