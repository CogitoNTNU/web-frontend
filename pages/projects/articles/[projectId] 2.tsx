...
const GithubButton = ({ link }: GithubButtonProps) => {
  return (
    <div className="relative w-[14rem] h-[2.75rem] rounded-3xl group">
...
const TeamMember = ({
  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center w-32 h-32 bg-black-dark bg-opacity-50 rounded-[100rem]">
        <Image
